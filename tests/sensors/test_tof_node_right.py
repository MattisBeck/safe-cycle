"""Tests für den ToF-Sensor-Node (VL53L1X mit Pimoroni-Bibliothek) (rechts)."""

from unittest.mock import Mock

from sensors.tof_node_right import create_tof_payload, read_sensor


def test_tof_node_can_be_imported() -> None:
    """Prüft, ob das ToF-Modul ohne angeschlossene Hardware importierbar ist."""
    from sensors import tof_node_right

    assert tof_node_right.__name__ == "sensors.tof_node_right"
